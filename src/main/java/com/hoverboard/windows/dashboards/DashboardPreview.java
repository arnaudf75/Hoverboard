...
public class DashboardPreview extends JPanel implements ActionListener {
    ...
    private final JLabel persoIcon = new JLabel (new ImageIcon(this.getClass().getResource("/images/solo.png")));
    private final JLabel sharedIcon = new JLabel (new ImageIcon(this.getClass().getResource("/images/groupofpeople.png")));
    private final JLabel adminIcon = new JLabel (new ImageIcon(this.getClass().getResource("/images/admin.png")));
